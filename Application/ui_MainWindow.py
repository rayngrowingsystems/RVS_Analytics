...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_save_analysis.setEnabled(False)
        ...
        sizePolicy2.setHeightForWidth(self.timestamp_label.sizePolicy().hasHeightForWidth())
        self.timestamp_label.setSizePolicy(sizePolicy2)
        ...
        sizePolicy4.setHeightForWidth(self.image_source_button.sizePolicy().hasHeightForWidth())
        self.image_source_button.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.image_roi_button.sizePolicy().hasHeightForWidth())
        self.image_roi_button.setSizePolicy(sizePolicy4)
